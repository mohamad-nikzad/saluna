      ...
      >
        ...
        <div
          ...
          className={cn(
            ...
            // Floating gets padding on every side; inset only keeps the gap
            // between the sidebar and the content pane.
            variant === "floating"
              ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+1rem+2px)]"
              : variant === "inset"
                ? "group-data-[side=left]:pr-2 group-data-[side=right]:pl-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+0.5rem+2px)]"
        ...
        >
          <div
            ...
            className={cn(
              ...
              "group-data-[variant=inset]:group-data-[side=left]:border-r group-data-[variant=inset]:group-data-[side=right]:border-l group-data-[variant=inset]:border-sidebar-border"
            )}
          >
            {children}
          </div>
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ms-2 md:peer-data-[variant=inset]:ms-0",
        className
      )}
      {...props}
    />
...
>(({ className, showIcon = false, width = "67%", ...props }, ref) => {
  return (
    <div
      ref={ref}
