...
- [BL-0032 Create and recognize a Setup Salon](done/BL-0032-create-and-recognize-setup-salon.md)
- [BL-0030 Separate session cookies per app (PWA vs admin)](done/BL-0030-separate-session-cookies-per-app.md)
- [BL-0029 Version PWA install icons and manifest asset URLs](done/BL-0029-pwa-icon-asset-versioning.md)
...
- [BL-0035 Create and claim unclaimed Staff Profiles](done/BL-0035-create-and-claim-unclaimed-staff-profiles.md)
